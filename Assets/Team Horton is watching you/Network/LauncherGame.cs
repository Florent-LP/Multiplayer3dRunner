...
{
	public class LauncherGame : Photon.PunBehaviour {
		...
		*/
		...
		public void joinRoom(){
			PhotonNetwork.JoinOrCreateRoom(roomNameGO.GetComponent<Text>().text, new RoomOptions() { MaxPlayers = this.maxPlayersPerRoom}, null);
		}
